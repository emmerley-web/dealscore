...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Header — dark, visual weight */}
      <section className="bg-stone-900 py-20 sm:py-28 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="hidden lg:block">
              <div className="overflow-hidden h-[380px] bg-stone-800">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-5 text-stone-600 leading-relaxed text-base">
            ...
            <p>
              ...
              had no idea that a publisher&rsquo;s decision rests on a small set of concrete,
          ...
          <div className="space-y-14">
            ...
            <div className="grid sm:grid-cols-[auto_1fr] gap-8">
              <div className="flex flex-col items-center sm:items-start gap-4">
                <div className="w-36 h-36 overflow-hidden flex-shrink-0 bg-stone-100">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
              ...
              <div className="space-y-4 text-stone-600 leading-relaxed text-sm sm:text-base">
                <p>
                  ...
                  Penguin Random House, Simon &amp; Schuster, and Hachette. He&rsquo;s been
                  a full-time ghostwriter since 2005.
                </p>
                <p>
                  ...
                  DeVon Franklin and Meagan Good) and{" "}
                ...
                <p>
                  ...
                  they&rsquo;ve spent years wondering why the answer was no.
                </p>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-[auto_1fr] gap-8">
              ...
              <div className="space-y-4 text-stone-600 leading-relaxed text-sm sm:text-base">
                ...
                <p>
                  She&rsquo;s worked with clients across four continents on memoirs,
                  narrative business books, and proposals aimed at traditional publishers,
                  with a particular focus on helping authors whose stories are ready
                  before their platform catches up.
                </p>
                <p>
                  ...
                  the challenge of making Tim&rsquo;s publishing framework accessible at scale.
                </p>
              </div>
            </div>
          ...
          <div className="grid sm:grid-cols-3 gap-10">
            <div>
              ...
              <p className="text-base text-stone-500 leading-relaxed">
                There aren&rsquo;t universal rules in publishing. The right editor,
            ...
            <div>
              ...
              <p className="text-base text-stone-500 leading-relaxed">
                ...
                their situation, whatever that turns out to be.
              </p>
            </div>
            <div>
              ...
              <p className="text-base text-stone-500 leading-relaxed">
                ...
                The problem is they don&rsquo;t know which variables matter most.
                That knowledge gap is itself a form of expertise, and it&rsquo;s
