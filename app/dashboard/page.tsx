          ...
          {selected && (
            <div className="lg:col-span-3 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
              ...
              <div className="mt-5 flex gap-3">
                <Link
                  href="/tactics"
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-brand-50 hover:bg-brand-100 text-brand-700 font-semibold text-sm rounded-xl transition-colors border border-brand-200"
                >
                  View Tactics
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {latest.categoryScores.map((cat) => {
                ...
                return (
                  ...
                  >
                    <div className="text-xs text-slate-500 font-medium mb-1 leading-tight">
