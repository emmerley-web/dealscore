      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="hidden print:flex items-center justify-between pb-4 border-b border-stone-200">
          <span className="font-serif font-bold text-stone-900 text-xl tracking-tight">
            Pitch<span className="text-stone-600">Mark</span>
          </span>
          <span className="text-stone-400 text-sm">
            Assessment Results &middot; {new Date().toLocaleDateString("en-GB", { day: "numeric", month: "long", year: "numeric" })}
          </span>
        </div>
        ...
        <div className="print:hidden space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-5 py-3.5 bg-white hover:bg-stone-50 border border-stone-200 hover:border-stone-400 text-stone-600 font-semibold text-sm rounded-xl transition-all"
          >
        ...
        {/* Print-only footer */}
        <div className="hidden print:block pt-4 border-t border-stone-200 text-center">
          <p className="text-xs text-stone-400">
            Generated by PitchMark &middot; canigetabookdeal.com
          </p>
        </div>
